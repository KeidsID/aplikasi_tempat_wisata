...
var tourismPlaceList = [
  TourismPlace(
    ...
    ticketPrice: 'Rp.25.000,00',
    imageAsset: 'assets/images/assets_image_wisata/farm-house.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    ticketPrice: 'Rp.20.000,00',
    imageAsset: 'assets/images/assets_image_wisata/bosscha.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    openTime: '24 hours',
    ticketPrice: 'Free',
    imageAsset: 'assets/images/assets_image_wisata/jalan-asia-afrika.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    ticketPrice: 'Rp.3.000,00',
    imageAsset: 'assets/images/assets_image_wisata/stone-garden.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    openTime: '24 hours',
    ticketPrice: 'Free',
    imageAsset: 'assets/images/assets_image_wisata/taman-film.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    ticketPrice: 'Rp.3.000,00',
    imageAsset: 'assets/images/assets_image_wisata/museum-geologi.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    ticketPrice: 'Rp.20.000,00',
    imageAsset: 'assets/images/assets_image_wisata/floating-market.png',
    imageUrls: [
  ...
  TourismPlace(
    ...
    ticketPrice: 'Rp.15.000,00',
    imageAsset: 'assets/images/assets_image_wisata/kawah-putih.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    openTime: '24 hours',
    ticketPrice: 'Rp.20.000,00',
    imageAsset: 'assets/images/assets_image_wisata/ranca-upas.jpg',
    imageUrls: [
